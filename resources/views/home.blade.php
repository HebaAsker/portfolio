@include('layouts.side_nav')
    ...
    <main id="main">
        ...
        <div class="container">
            ...
            <h2>About</h2>
            <p>{{ $user->about_description }}</p>
            </div>

            <div class="row">
            <div class="col-lg-4" data-aos="fade-right">
                <img src="{{ asset('assets/uploads/'. $user->photo) }}" class="img-fluid" alt="">
            </div>
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                ...
                <div class="col-lg-6">
                    <ul>
                    <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span></span>{{ $user->getAge() }}</li>
                    ...
                    <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span>{{ $user->freelance_status }}</span></li>
                    </ul>
                </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($services as $service)
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100}}">
